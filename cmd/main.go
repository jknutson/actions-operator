...
import (
	...
	"github.com/jknutson/actions-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "19ee5c1b.actions-operator.io",
	...
	if err = (&controller.ActionsOperatorReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ActionsOperator")
		os.Exit(1)
	}
